...
<p>If you're ready to take the plunge, start with <a href="/how-to-choose-wordpress-hosting/">choosing your hosting</a> — everything else flows from that decision. Set up your site, pick a clean theme from the <a href="/best-free-wordpress-themes/">best free WordPress themes</a>, install the <a href="/must-have-plugins-new-site/">essential plugins</a>, and publish your first post this week. Once your blog is live, our <a href="/tutorials">WordPress tutorials</a> will walk you through everything from SEO to backups. Not next month, not "when you're ready" — this week. The best time to start a blog was five years ago. The second best time is right now.</p>
`;
