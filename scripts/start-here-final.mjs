...
await p.screenshot({ path: '/tmp/start-here-audit/final-desktop.png', fullPage: true });
...
await p2.screenshot({ path: '/tmp/start-here-audit/final-mobile.png', fullPage: true });
