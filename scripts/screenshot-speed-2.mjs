...
const screenshots = [
  {
    ...
    path: "public/screenshots/cloudflare-homepage.webp",
    name: "Cloudflare homepage",
  },
  {
    url: "https://wordpress.org/plugins/wp-optimize/",
    path: "public/screenshots/wp-optimize-plugin.webp",
    name: "WP-Optimize plugin",
  },
  {
    url: "https://wordpress.org/plugins/a3-lazy-load/",
    path: "public/screenshots/a3-lazy-load-plugin.webp",
    name: "a3 Lazy Load plugin",
  },
  {
    url: "https://bunny.net/",
    path: "public/screenshots/bunnycdn-homepage.webp",
    name: "BunnyCDN homepage",
  },
];
